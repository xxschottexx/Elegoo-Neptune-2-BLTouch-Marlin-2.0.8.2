...
#define STRING_CONFIG_H_AUTHOR "(xxschottexx, Neptune 2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Neptune 2"
...
//#define PSU_NAME "Power Supply"
  ...
  //#define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    #define AUTO_POWER_COOLER_TEMP   30 // (°C) Turn on PSU if the cooler is over this temperature
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.6, 80.4, 400, 138.46 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 32.55, -7, -0.8 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FI_RUNOUT_PIN       PA4         // MT_DET
